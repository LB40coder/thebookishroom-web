...
"[project]/apps/api/src/app/api/public/books/filter/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (slugs?.length) {
        const books = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$data$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBooksBySlugs"])(slugs);
    ...
    const books = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$data$2f$books$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["filterPublishedBooks"])({
        mood,
        genre,
        length,
        difficulty
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0mveb_m._.js.map